...
$pdf->Image('img/watermark.png',40,103);
...
$pdf->Cell(100,30,'Faculty : '.$t_name,0);
$pdf->Ln();
...
$pdf->Cell(0,-20,'Note : 0-20% = Poor, 21-40% = Need Improvement,41-60% = Satisfactory, 61-80% = Good, 81-100% = Excellent',0,1);
$pdf->Ln();
...
/* Tptal Score */
$pdf->SetFont('Arial','B',25);
$pdf->Cell(0,100,'Total Score : '.$final_score.' %',0,1,'C');
