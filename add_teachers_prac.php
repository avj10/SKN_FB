...
{ 
  ...
  $sql = "INSERT INTO teacher_prac ( P_Name, P_Course_Code, P_Year, P_Semester, P_division, P_batch)
      VALUES ('".$rowData[0][0]."', '".$rowData[0][1]."', '".$rowData[0][2]."',  '".$rowData[0][3]."',  '".$rowData[0][4]."',  '".$rowData[0][5]."')";
     //$cnt = $cnt + 1; 
  if (mysqli_query($db, $sql)) {
    $exceldata[] = $rowData[0];
     for($cnt = 1; $cnt<=6;$cnt++){
    $sql_out = "INSERT INTO prac_output (P_Name, P_Course_Code, P_Year,  P_Sem, P_div, P_batch, Q_id,  tot_cont)
      VALUES ('".$rowData[0][0]."', '".$rowData[0][1]."', '".$rowData[0][2]."',  '".$rowData[0][3]."', '".$rowData[0][4]."',  '".$rowData[0][5]."', '$cnt', '0')";
