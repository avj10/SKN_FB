 ...
 a {
  ...
  <body>
    ...
    <div class="form-style-10">
      <h1>View Reports for Feedback</h1>
    <main role="main" class="container">
     <center> <div class="jumbotron">
      <div class="row">
        <div class="col-6"> 

            <h2>Select Theory Teacher</h2>
               <br>
    ...
    <select class="form-control" id="sel1"  name="teacher">
       ...
       include('includes/db.php');
        $query = mysqli_query($db,"SELECT distinct(T_Name) FROM teacher_theory");
    ...
    <br>
     <div class="form-group">        
        ...
        <div class="col-6"> 
<h2>Select Practical Teacher</h2>
   <br>
        <form action="view_report_prac.php" method="post" enctype="multipart/form-data">
    <div class="form-group">
    <select class="form-control" id="sel1"  name="teacher">
            <option value="" style="display: none"></option>
       <?php
       include('includes/db.php');
        $query = mysqli_query($db,"SELECT distinct(P_Name) FROM teacher_prac");
        while($row = mysqli_fetch_object($query)){
