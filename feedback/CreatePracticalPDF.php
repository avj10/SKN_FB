...
$pdf->Cell(22,60,'/ '.$present_feedback,0);
$pdf->Cell(70,60,'Teaching Speed : ',0);
$pdf->Cell(8,60,$speed,0);
$pdf->Cell(22,60,'/ '.$present_feedback,0);
$pdf->Ln();

$pdf->Cell(60,-30,'English : ',0);
$pdf->Cell(8,-30,$english,0);
$pdf->Cell(22,-30,'/ '.$present_feedback,0);
...
/* Tptal Score */
$pdf->SetFont('Arial','B',25);
$pdf->Cell(0,140,'Total Score : '.$final_score,0,1,'C');
