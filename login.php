  ...
  if(empty($roll)){
    ...
    if($result = mysqli_query($db,$query)){
      while($row = mysqli_fetch_object($result)){
        if($row->theory==1 && $row->practical==1){
        echo '<script language="javascript">'; 
 ...
 a {
  ...
  <body>
    ...
    <div class="form-style-10">
      <h1>Login to Give Feedback</h1>
    <main role="main" class="container">
     <center> <div class="jumbotron col-sm-6">
      <form action="#" method="post">
    <div class="form-group">
        <input type="text" class="form-control" id="rollno" placeholder="e.g 18U101" name="rollno" required><br>
        <select class="form-control" id="sel1" required  name="year">
            <option value="" style="display: none" placeholder="Division">Year</option>
