...
?>
      ...
      <div class="section"><h4><span><?php echo $i;?></span> <?php echo $row1->T_Course_Name;?> - <?php echo $row1->T_Name;?></h4></div>
      <div class="form-group col-sm-14">
        <div class="col-sm-10"> 
          <tr>
            <td><label class="subject" for="sel1"><h5>Voice</h5></label></td>

            <td> <select class="form-control" id="sel1" name="<?php echo $code."1"?>">
...
<option value="2">Need Improvements</option>
        <option value="1">Poor</option>
          ...
          <td><label class="subject" for="sel1"><h5>Preparation</h5></label></td>
            ...
            <td> <select class="form-control" id="sel1"  name="<?php echo $code."2"?>">
            <option value="" style="display: none"></option>
        <option value="5">Excellent</option>
        <option value="4">Good</option>
        <option value="3">Satisfactory</option>
<option value="2">Need Improvements</option>
        <option value="1">Poor</option>
            ...
            <td> <select class="form-control" id="sel1"  name="<?php echo $code."3"?>">
            <option value="" style="display: none"></option>
        <option value="5">Excellent</option>
        <option value="4">Good</option>
        <option value="3">Satisfactory</option>
<option value="2">Need Improvements</option>
        <option value="1">Poor</option>
            ...
            <td> <select class="form-control" id="sel1"  name="<?php echo $code."4"?>">
            <option value="" style="display: none"></option>
        <option value="5">Excellent</option>
        <option value="4">Good</option>
        <option value="3">Satisfactory</option>
<option value="2">Need Improvements</option>
        <option value="1">Poor</option>
           ...
           <td><label class="subject" for="sel1"><h5>Interaction</h5></label></td>
            ...
            <td> <select class="form-control" id="sel1"  name="<?php echo $code."5"?>">
            <option value="" style="display: none"></option>
        <option value="5">Excellent</option>
        <option value="4">Good</option>
        <option value="3">Satisfactory</option>
<option value="2">Need Improvements</option>
        <option value="1">Poor</option>
           ...
           <td><label class="subject" for="sel1"><h5>Punctuality</h5></label></td>
            ...
            <td> <select class="form-control" id="sel1" name="<?php echo $code."6"?>">
            <option value="" style="display: none"></option>
        <option value="5">Excellent</option>
        <option value="4">Good</option>
        <option value="3">Satisfactory</option>
<option value="2">Need Improvements</option>
        <option value="1">Poor</option>
          ...
          <tr>
            ...
            <td> <select class="form-control" id="sel1"  name="<?php echo $code."7"?>">
            <option value="" style="display: none"></option>
        <option value="5">Excellent</option>
        <option value="4">Good</option>
        <option value="3">Satisfactory</option>
<option value="2">Need Improvements</option>
        <option value="1">Poor</option>
           ...
           <td><label class="subject" for="sel1"><h5>Teaching Speed</h5></label></td>
            ...
            <td> <select class="form-control" id="sel1"  name="<?php echo $code."8"?>">
            <option value="" style="display: none"></option>
        <option value="5">Excellent</option>
        <option value="4">Good</option>
        <option value="3">Satisfactory</option>
<option value="2">Need Improvements</option>
        <option value="1">Poor</option>
           ...
           <td><label class="subject" for="sel1"><h5>English</h5></label></td>
            ...
            <td> <select class="form-control" id="sel1"  name="<?php echo $code."9"?>">
            <option value="" style="display: none"></option>
        <option value="5">Excellent</option>
        <option value="4">Good</option>
        <option value="3">Satisfactory</option>
